...
function oneClickGetPopupHtml(extension) {
  ...
  //   mail = `1click-facebook-reader@1ce.org`,
  //   	rateLink = `https://chrome.google.com/webstore/detail/blablacnjddhdiiinlplpilppfpegaop/reviews`,
  // 	  githubLink = `https://github.com/1click-extensions/1click-facebook-reader`;
...
.please-rate-title{
	...
	<div class="pleaseRate">
		<div class="please-rate-text">
			If you like 1Click Facebook Reader <a target=_blank href="https://chrome.google.com/webstore/detail/blablacnjddhdiiinlplpilppfpegaop/reviews" >please give us 5-stars</a>
			<br/>
			<div class="addition">To report a bug please <a href="https://github.com/1click-extensions/1click-facebook-reader/issues/new">submit issue</a> 
			</div>
