...
.please-rate-title{
	...
	<div class="please-rate-title">What do you think about this extension?</div>
		...
		<div class="please-rate-text">
			...
			<br/>
			<div class="addition">
				In addition, If you want to report a bug, or you have a recommendation, please <a href="https://github.com/1click-extensions/1click-facebook-reader/issues/new">report a public issue</a> or  <a href="mailto:1click-facebook-reader@1ce.org">Contact us</a>
			</div>
			<div class="skip-wrp"><button type="button" class="btn-popup no-thanks ">Skip</button></div>
		</div>
		<a class="please-rate-github" href="https://github.com/1click-extensions/1click-facebook-reader">Fork on github</a>
	</div>
	`)
}
